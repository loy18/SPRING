	...
	<div class="card card-primary">
		...
		<div class="card-body">
			<div class="row">
				...
				2. a 태그로 띄우기
				<a data-toglle="modal" href="#modal-defalut">Open Modal</a>
						...
						<div class="input-group justify-content-between">
							<div class="custom-file" style="float:left;">
								<input type="file" class="custom-file-input"
									id="uploadFile" name="uploadFile" style="width:200px;" cursorshover="true"> 
...
<script type="text/javascript">
	$(function() {
		...
		//수정 버튼 클릭 -> spn:hidden / spn2: block
		...
		$("#uploadBtn").on("click", function(e){
			...
			for(let i=0;i<files.length;i++){
				//파일 확장자/크기 체킹(확장자가 exe, sh,  zip, alz 이니? 안되는데..)
		...
		$("#delete").on("click",function(){
			...
			$.ajax({
				...
				success:function(result){
					...
					//성공 시 : /gallery/list?bookId=3 / 실패 시 : 실패메시지 alert
							if(str >0){
								location.href="/gallery/list?bookId=${param.bookId}";
							}else{
								alert("삭제 실패하였습니다.")
