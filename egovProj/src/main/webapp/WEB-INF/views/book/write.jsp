		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="input-group date" id="reservationdate"
					...
					<input type="text"  name="title" readonly class="form-control rounded-0"  value="${bookVO.title }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group">
					<textarea  name="content"  readonly class="form-control rounded-0">${bookVO.content }</textarea>
				</div>
			</div>
